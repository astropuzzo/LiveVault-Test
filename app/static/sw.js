const CACHE='livevault-shell-v2.8.24-ordered-processing1';
const SHELL=['/static/style.css','/static/enhancements.css','/static/attention-fix.css','/static/app.js','/static/attention-fix.js','/static/icon.svg','/manifest.webmanifest'];
