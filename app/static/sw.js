const CACHE='livevault-shell-v3.0.0-redesign1';
const SHELL=['/static/style.css','/static/icons.svg','/static/app.js','/static/operations.js','/static/workspace.js','/static/ui.js','/static/icon.svg','/manifest.webmanifest'];
