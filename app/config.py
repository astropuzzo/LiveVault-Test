...
class Settings:
    ...
    segment_minutes: int = _int("SEGMENT_MINUTES", 30)
    ...
    min_free_gb: float = _float("MIN_FREE_GB", 5.0)
    critical_free_gb: float = _float("CRITICAL_FREE_GB", 2.0)
    emergency_free_gb: float = _float("EMERGENCY_FREE_GB", 1.0)
    upload_retry_seconds: int = _int("UPLOAD_RETRY_SECONDS", 300)
