const CACHE = "openastro-control-v21.0-glass";
const SHELL = ["/app.css", "/shell.css", "/theme.css", "/premium.css", "/magic.css", "/media-upload.css", "/glass.css", "/app.js", "/media-upload.js", "/hls.min.js", "/icon.svg", "/manifest.webmanifest"];
